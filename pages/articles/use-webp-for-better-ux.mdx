...
So we need fallback images to support wider range of browsers. Let's first optimize our raw images with their formats.
...
The `prepare` script will execute after installation. This will allow us to build our image assets in workflows of our choice.
