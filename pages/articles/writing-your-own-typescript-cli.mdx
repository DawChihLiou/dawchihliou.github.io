...
Feel free to install it and use it in your development workflow. Please give it a ⭐️ on [GitHub](https://github.com/DawChihLiou/dx-scripts) if the scripts are useful:)
