    ...
    IKlv: function (e, t, r) {
              ...
              function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 36:
                      return (
                        (t.router = Q = (0, A.createRouter)(R, O, G, {
                          initialProps: M,
                          pageLoader: J,
                          App: z,
                          Component: Z,
                          ...
                          subscription: function (e, t) {
                            return oe(Object.assign({}, e, { App: t }))
                          },
                          locale: H,
                          locales: q,
                          defaultLocale: W,
          ...
          J.loadPage('/_error').then(function (n) {
            var o = n.page,
              ...
              u = {
                ...
                AppTree: i,
                router: Q,
                ctx: { err: r, pathname: R, query: O, asPath: G, AppTree: i },
              }
      ...
      function le(e) {
        ...
        return h.default.createElement(
          ...
          {
            fn: function (e) {
              return ie({ App: z, err: e }).catch(function (e) {
      ...
      function de(e) {
        ...
        return (
          ...
          ue
            ? (v.default.hydrate(f, l, ce), (ue = !1))
            : v.default.render(f, l, se),
          s
        )
      }
      function me(e) {
      ...
      var d = (function () {
        function e(t, r) {
          n(this, e),
            ...
            (this.routeLoader = (0, l.default)(r)),
            (this.buildId = t),
            (this.assetPrefix = r),
