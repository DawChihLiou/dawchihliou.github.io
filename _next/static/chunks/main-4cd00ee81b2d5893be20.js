  ...
  [6],
  {
    ...
    IKlv: function (e, t, n) {
      ...
      var k = N.props,
        ...
        j = L || ''
      ;(n.p = ''.concat(j, '/_next/')),
        P.setConfig({ serverRuntimeConfig: {}, publicRuntimeConfig: F || {} })
      var U = (0, T.getURL)()
      ;(0, S.hasBasePath)(U) && (U = (0, S.delBasePath)(U))
      var O = new x.default(D, j, M),
        H = function (e) {
          var t = l(e, 2),
            n = t[0],
            r = t[1]
              ...
              function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 30:
                      return (
                        (t.router = G = (0, C.createRouter)(M, I, U, {
                          initialProps: k,
                          pageLoader: O,
                          App: V,
                          Component: Y,
          ...
          O.loadPage('/_error').then(function (r) {
            var a = r.page,
              ...
              u = {
                ...
                AppTree: i,
                router: G,
                ctx: { err: n, pathname: M, query: I, asPath: U, AppTree: i },
              }
      ...
      var se = function (e) {
        return function (t) {
          var n = (0, h.default)({}, t, { Component: Y, err: A, router: G })
          return m.default.createElement(
            ce,
            null,
        ...
        return (
          a(e, [
            ...
            },
            {
              ...
              value: function (e, t, n) {
                var r,
                  ...
                  E = (0, l.isDynamicRoute)(w)
                if (E) {
                  var P = (0, h.getRouteRegex)(w),
                    T = P.groups,
            ...
            },
            {
              ...
              value: function (e, t) {
                var n = this,
                  r = S((0, f.parseRelativeUrl)(e).pathname)
              ...
              value: function (e, t) {
                ...
                return Promise.all(
                  document.querySelector(
                    ...
                    ? []
                    : [
                        r && _(r, y, r.endsWith('.css') ? 'fetch' : 'script'),
                        !t &&
                          this.getDependencies(e).then(function (e) {
                            return Promise.all(
                              e.map(function (e) {
