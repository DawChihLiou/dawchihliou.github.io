;(window.webpackJsonp_N_E = window.webpackJsonp_N_E || []).push([
  [4],
  {
    ...
    elyg: function (t, e, r) {
      ...
      function O(t, e, r) {
        return { url: P(C(t.pathname, e)), as: r ? P(C(t.pathname, r)) : r }
      }
      var I = 'SSG Data NOT_FOUND'
      function j(t, e) {
        return fetch(t, { credentials: 'same-origin' }).then(function (r) {
          if (!r.ok) {
            if (e > 1 && r.status >= 500) return j(t, e - 1)
            if (404 === r.status) throw new Error(I)
                      ...
                      function (e) {
                        for (;;)
                          switch ((e.prev = e.next)) {
                            ...
                            case 38:
                              ;(j = e.sent), j.__rewrites, (e.next = 46)
                              break
                            case 42:
                              return (
                                (e.prev = 42),
                            ...
                            case 46:
                              if (
                                ((m = this._resolveHref(m, I)).pathname !== _ &&
                                  ((_ = m.pathname),
                                  (n = (0, h.formatWithValidation)(m))),
                                (_ = _
                                  ? (0, c.removePathTrailingSlash)(k(_))
                                  : _),
                                this.urlIsNew(p) || u || (r = 'replaceState'),
                                (T = (0, c.removePathTrailingSlash)(_)),
                              ...
                              if (
                                ...
                                (D = M.pathname),
                                (N = (0, g.getRouteRegex)(T)),
                                (U = (0, y.getRouteMatcher)(N)(D)),
                                (q = (W = T === D) ? R(T, D, C) : {}),
                                U && (!W || q.result))
                              ) {
                                e.next = 68
                              ...
                              if (
                                !(
                                  (F = Object.keys(N.groups).filter(function (
                                    t
                                  ) {
                                    return !C[t]
                                  })).length > 0
                            ...
                            case 73:
                              ...
                              if (
                                !(X = H.pageProps.__N_REDIRECT).startsWith('/')
                              ) {
                                e.next = 83
                                break
                              }
                              if (
                                ((J = (0, v.parseRelativeUrl)(X)),
                                this._resolveHref(J, I, !1),
                                !I.includes(J.pathname))
                              ) {
                                e.next = 83
                                break
                              }
                              return (
                                ...
                                ($ = Y.url),
                                (Q = Y.as),
                                e.abrupt('return', this.change(r, $, Q, i))
                              )
                            case 83:
                              return (
                            ...
                            case 85:
                              return (
                                ...
                                this.changeState(r, n, a, i),
                                (e.next = 90),
                                this.set(T, _, C, p, G).catch(function (t) {
                      ...
                      function (e) {
                        for (;;)
                          switch ((e.prev = e.next)) {
                            ...
                            case 28:
                              ;(m = e.sent), (l = m.page), (f = m.styleSheets)
                            case 31:
                              if (
                                (y = {
                                  props: h,
            ...
            },
            {
              ...
              value: function (t) {
                ...
                return this.sdc[r]
                  ...
                  : T(t, this.isSsr).then(function (t) {
                      return (e.sdc[r] = t), t
                    })
              },
            },
