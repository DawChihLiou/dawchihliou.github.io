  ...
  [13],
  {
          ...
          T(
            ...
            x.map(function (e, t) {
              ...
              return T(
                ...
                T(
                  'a',
                  { href: v.a.linkedin, target: '_blank', rel: 'noreferrer' },
                  T('p', null, '" ', e.quote, ' "'),
                  T(
                    'div',
        ...
        return $(
          ...
          $(
            ...
            W.map(function (e) {
              return $(
                'article',
                { key: e.title, className: q.a.item },
                $(
                  'a',
                  { href: e.url, target: '_blank', rel: 'noreferrer' },
                  $(
                    'div',
                    { className: q.a.itemDescription },
                    $('h2', null, e.title),
          ...
          $(
            'a',
            { href: '/articles', className: q.a.link },
            'See more articles'
          )
        )
      }
          ...
          for (
            ...
            if ('\t' !== (h = A.charAt(o)) && ' ' !== h) {
              if ('' === h || '|' === h)
                ...
                for (y = 1; A.charAt(o + 1) === h; ) (m += h), o++, y++
                v ? y >= v && (v = 0) : (v = y)
              }
              ;(g = !1), o++
            } else m ? (f += h) : e(h), o++
    ...
    NiDC: function (e, t, n) {
      ...
      e.exports = function (e, t, n) {
        ...
        for (; y < v; ) {
          ...
          if (((s = t.slice(y + 1)), a(g, m, this, [e, s, !0]))) break
          if (
        ...
        if (((s = t.slice(0, y)), '' === r(s))) return e(s), null
        if (n) return !0
        return (
          (f = e.now()),
          (s = i(s)),
        ...
        for (; R < D; ) {
          ...
          if (
            ...
            if (!0 === d[c]) (v = c), R++, M++
              ...
              ;(c = t.charAt(R)),
                R++,
                a && !0 === o[c] && ((v = c), (M += a.length + 1))
            }
            if (v)
              if ('\t' === (c = t.charAt(R))) (M += 4 - (M % 4)), R++
              else if (' ' === c) {
                for (N = R + 4; R < N && ' ' === t.charAt(R); ) R++, M++
                R === N && ' ' === t.charAt(R) && ((R -= 3), (M -= 3))
              } else '\n' !== c && '' !== c && (v = null)
          }
          if (v) {
            if (!H && u !== v) break
    ...
    O5o4: function (e, t, n) {
      e.exports = {
        ...
        dark: 'Recommendation_dark__3kFSy',
    ...
    Syd7: function (e, t, n) {
      ...
      e.exports = function (e, t, n) {
        var o,
          ...
          v = ''
        if (!m.gfm) return
        for (; y < g && (' ' === (a = t.charAt(y)) || '\t' === a); )
          (v += a), y++
        if (((p = y), '~' !== (a = t.charAt(y)) && '`' !== a)) return
        y++, (i = a), (o = 1), (v += a)
        for (; y < g && (a = t.charAt(y)) === i; ) (v += a), o++, y++
        if (o < 3) return
        for (; y < g && (' ' === (a = t.charAt(y)) || '\t' === a); )
          (v += a), y++
        ;(l = ''), (s = '')
        ...
        for (; y < g; )
          if (
            ...
            if (((f += s), (h += s.slice(p)), !(s.length >= 4))) {
              for (s = ''; y < g && (a = t.charAt(y)) === i; ) (s += a), y++
        ...
        return e((v += c + f))({ type: 'code', lang: l || null, value: r(u) })
      }
    },
    TOwV: function (e, t, n) {
      'use strict'
    ...
    Y6TP: function (e, t, n) {
      ...
      e.exports = function (e, t) {
        ...
        return (function (e, t) {
              ...
              ;(a = 59 === e.charCodeAt(H)) &&
                ...
                A
                  ? (te(),
                    ...
                    Q.push(A),
                    (E = K()).offset++,
                    D && D.call(q, A, { start: N, end: E }, e.slice(I - 1, H)),
                    (N = E))
                  : ((h = e.slice(I - 1, H)),
                    (Y += h),
                    (X += h.length),
          ...
          function ee(e, t) {
            var n = K()
            ;(n.column += t), (n.offset += t), F.call(U, v[e], n, e)
          }
          function te() {
            Y &&
              (Q.push(Y), R && R.call(M, Y, { start: N, end: K() }), (Y = ''))
          }
        })(e, a)
      }
        ...
        if ('[' === (c = t.charAt(m))) {
          ...
          if (s && ']' === t.charAt(m) && ':' === t.charAt(m + 1)) {
            for (
              ...
              (y += c), m++
            if (((s = ''), (r = y), '<' === (c = t.charAt(m)))) {
              for (m++; m < g && a((c = t.charAt(m))); ) (s += c), m++
              if ((c = t.charAt(m)) === a.delimiter) (y += '<' + s + c), m++
              else {
                if (d) return
                ;(m -= s.length + 1), (s = '')
              }
