      ...
      function m(e) {
        ...
        return y(
          ...
          y(
            ...
            null,
            y('title', null, n),
            y('meta', { name: 'description', content: r }),
            y('meta', { property: 'og:title', content: n }),
            y('meta', { property: 'og:type', content: 'website' }),
            y('meta', { property: 'og:url', content: u }),
            y('meta', { property: 'og:description', content: r }),
            y('meta', {
              property: 'og:image',
              content: ''.concat(p.a.home).concat(f),
            }),
            y('meta', { property: 'og:image:type', content: 'image/png' }),
            y('meta', { property: 'og:image:width', content: m }),
            y('meta', { property: 'og:image:height', content: v }),
            y('meta', { property: 'og:image:alt', content: r })
          ),
          y(
            'article',
            null,
            y(
              ...
              y('div', { className: c.a.wrap }, t, !g && y(d, null))
            )
          )
        )
      }
      ...
      var p = o.a.createContext({}),
        ...
        l = o.a.forwardRef(function (e, t) {
          var n = e.components,
            ...
            l = s(n),
            d = r,
            y = l[''.concat(i, '.').concat(d)] || l[d] || f[d] || a
          return n
            ? o.a.createElement(y, u(u({ ref: t }, p), {}, { components: n }))
            : o.a.createElement(y, u({ ref: t }, p))
        })
      function d(e, t) {
        var n = arguments,
          r = t && t.mdxType
