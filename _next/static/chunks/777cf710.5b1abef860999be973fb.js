    ...
    QczR: function (t, e, n) {
      ...
      var r = (function (t) {
        ...
        i = (function (t) {
              ...
              if (
                ...
                return 1 == t.nodeType
                  ? 'xlink:' == e.substring(0, 6)
                    ...
                    : 'xml:' == e.substring(0, 4)
                    ? t.getAttributeNS(B, e.substring(4))
                    : t.getAttribute(e)
                  : 'text' == e
                  ? t.nodeValue
                  : null
                  ...
                  if (e[r](a)) {
                    ...
                    o
                      ? 'xlink:' == a.substring(0, 6)
                        ? t.setAttributeNS(w, a.substring(6), o)
                        : 'xml:' == a.substring(0, 4)
                        ? t.setAttributeNS(B, a.substring(4), o)
                        : t.setAttribute(a, o)
                      : t.removeAttribute(a)
                  }
          ...
          function S(t, e) {
            return 'finite' == (e = i.prototype.toLowerCase.call(e))
              ? isFinite(t)
              : !(
                  'array' != e ||
                  ...
                  (e == typeof t && null !== t) ||
                  ('object' == e && t === Object(t)) ||
                  f.call(t).slice(8, -1).toLowerCase() == e
          }
          function k(t, e) {
          ...
          ;(e._.$ = E),
            ...
            (e.closestPoint = function (t, e, n) {
              ...
              return (i = { x: i.x, y: i.y, length: a, distance: Math.sqrt(h) })
            }),
            (e.is = S),
            (e.snapTo = function (t, e, n) {
              if (((n = S(n, 'finite') ? n : 10), S(t, 'array'))) {
                for (var r = t.length; r--; ) if (c(t[r] - e) <= n) return t[r]
              } else {
                var i = e % (t = +t)
                if (i < n) return e - i
            ...
            (e.getRGB = D(function (t) {
              ...
              if ('none' == t)
                return { r: -1, g: -1, b: -1, hex: 'none', toString: j }
              if (
                (!v[r](t.toLowerCase().substring(0, 2)) &&
                  '#' != t.charAt() &&
                  (t = T(t)),
                !t)
              )
              ...
              return y
                ? (y[2] &&
                    ((h = o(y[2].substring(5), 16)),
                    (c = o(y[2].substring(3, 5), 16)),
                    (n = o(y[2].substring(1, 3), 16))),
                  y[3] &&
                    ((h = o((g = y[3].charAt(3)) + g, 16)),
                    (c = o((g = y[3].charAt(2)) + g, 16)),
                    (n = o((g = y[3].charAt(1)) + g, 16))),
                  y[4] &&
                    ((m = y[4].split(p)),
                    (n = a(m[0])),
                    '%' == m[0].slice(-1) && (n *= 2.55),
                    ...
                    (h = a(m[2])),
                    '%' == m[2].slice(-1) && (h *= 2.55),
                    'rgba' == y[1].toLowerCase().slice(0, 4) && (f = a(m[3])),
                  ...
                  y[5]
                    ? ((m = y[5].split(p)),
                      ...
                      ('deg' == m[0].slice(-3) || '\xb0' == m[0].slice(-1)) &&
                        (n /= 360),
                      'hsba' == y[1].toLowerCase().slice(0, 4) && (f = a(m[3])),
                      m[3] && '%' == m[3].slice(-1) && (f /= 100),
                      e.hsb2rgb(n, c, h, f))
                    : y[6]
                    ? ((m = y[6].split(p)),
                      ...
                      ('deg' == m[0].slice(-3) || '\xb0' == m[0].slice(-1)) &&
                        (n /= 360),
                      'hsla' == y[1].toLowerCase().slice(0, 4) && (f = a(m[3])),
                      m[3] && '%' == m[3].slice(-1) && (f /= 100),
                      e.hsl2rgb(n, c, h, f))
                    : ((n = l(s.round(n), 255)),
                      (c = l(s.round(c), 255)),
                      (h = l(s.round(h), 255)),
                      (f = l(u(f, 0), 1)),
                      ((y = { r: n, g: c, b: h, toString: j }).hex =
                        '#' +
                        (16777216 | h | (c << 8) | (n << 16))
                          .toString(16)
                          .slice(1)),
                      (y.opacity = S(f, 'finite') ? f : 1),
                      y))
                : { r: -1, g: -1, b: -1, hex: 'none', error: 1, toString: j }
            }, e)),
            (e.hsb = D(function (t, n, r) {
          ...
          ;(e.color = function (t) {
            var n
            return (
              S(t, 'object') && 'h' in t && 's' in t && 'b' in t
                ? ((n = e.hsb2rgb(t)),
                  (t.r = n.r),
                  (t.g = n.g),
                  (t.b = n.b),
                  (t.opacity = 1),
                  (t.hex = n.hex))
                : S(t, 'object') && 'h' in t && 's' in t && 'l' in t
                ? ((n = e.hsl2rgb(t)),
                  (t.r = n.r),
                  (t.g = n.g),
                  (t.b = n.b),
            ...
            (e.parsePathString = function (t) {
              ...
              var r = {
                ...
                a = []
              return (
                S(t, 'array') && S(t[0], 'array') && (a = e.path.clone(t)),
                a.length ||
                  i(t).replace(m, function (t, e, n) {
                    var i = [],
                      o = e.toLowerCase()
                    if (
                ...
                (a.toString = e.path.toString),
                (n.arr = e.path.clone(a)),
                a
              )
            })
          var q = (e.parseTransformString = function (t) {
            ...
            var n = []
            return (
              S(t, 'array') && S(t[0], 'array') && (n = e.path.clone(t)),
              n.length ||
                i(t).replace(y, function (t, e, r) {
                  var i = []
                  e.toLowerCase()
            ...
            return (
              (t = t.replace(/(?:^|\s)(\w+)\(([^)]+)\)/g, function (t, n, r) {
                return (
                  ...
                  'skewX' == n
                    ? e.push(['m', 1, 0, s.tan(_(r[0])), 1, 0, 0])
                    : 'skewY' == n
                    ? e.push(['m', 1, s.tan(_(r[0])), 0, 1, 0, 0])
              ...
              if (r)
                for (var o = 0, s = r.length; o < s; o++) {
                  ...
                  't' == g && 2 == p
                    ...
                    ? 2 == p
                      ? ((f = f || n),
                        a.rotate(d[1], f.x + f.width / 2, f.y + f.height / 2))
                      : 4 == p &&
                        (v
                          ? ((c = m.x(d[2], d[3])),
                            (h = m.y(d[2], d[3])),
                            a.rotate(d[1], c, h))
                          : a.rotate(d[1], d[2], d[3]))
                    : 's' == g
                    ? 2 == p || 3 == p
                      ? ((f = f || n),
                        a.scale(
                      ...
                      ? v
                        ? ((c = m.x(d[2], d[3])),
                          (h = m.y(d[2], d[3])),
                          a.scale(d[1], d[1], c, h))
                        : a.scale(d[1], d[1], d[2], d[3])
                      : 5 == p &&
                        (v
                          ? ((c = m.x(d[3], d[4])),
                            (h = m.y(d[3], d[4])),
                            a.scale(d[1], d[2], c, h))
                          : a.scale(d[1], d[2], d[3], d[4]))
                    : 'm' == g &&
                      7 == p &&
                      a.add(d[1], d[2], d[3], d[4], d[5], d[6])
                }
              return a
            }),
          ...
          function V(t) {
            return (
              (t.node.ownerSVGElement && X(t.node.ownerSVGElement)) ||
              e.select('svg')
            )
          }
          function O(t) {
          ...
          function U(t, e) {
            ...
            if (t && t.tagName && 'svg' == t.tagName.toLowerCase()) {
              ...
              for (var l in ((i = new G(t)),
              (a = t.getElementsByTagName('desc')[0]),
              (o = t.getElementsByTagName('defs')[0]),
              a ||
                ((a = E('desc')).appendChild(
                  u.createTextNode('Created with Snap')
                ),
                i.node.appendChild(a)),
              o || ((o = E('defs')), i.node.appendChild(o)),
              (i.defs = o),
              s))
                s[r](l) && (i[l] = s[l])
              i.paper = i.root = i
            } else
              E((i = z('svg', n.doc.body)).node, {
                height: e,
                version: 1.1,
                width: t,
                xmlns: B,
          ...
          function X(t) {
            return t
              ? t instanceof G || t instanceof R
                ...
                ? new U(t.contentDocument.getElementsByTagName('svg')[0])
                : new G(t)
              : t
          }
          function I(t, e) {
          ...
          ;(e._.getSomeDefs = function (t) {
            var n =
                (t.node.ownerSVGElement && X(t.node.ownerSVGElement)) ||
                (t.node.parentNode && X(t.node.parentNode)) ||
                e.select('svg') ||
                e(0, 0),
              r = n.select('defs'),
              i = null != r && r.node
            ...
            (G.prototype.attr = function (t, e) {
              var n = this,
                i = n.node
              if (!t) {
                if (1 != i.nodeType) return { text: i.nodeValue }
                for (
                  var a = i.attributes, o = {}, s = 0, u = a.length;
                  s < u;
                  s++
                )
            ...
            return (
              ...
              (function (e) {
                ...
                for (c = 0, h = a.length; c < h; c++) {
                  var d = o[a[c].old]
                  if (d) for (var p = 0, g = d.length; p < g; p++) d[p](a[c].id)
                }
              })(e),
              e.insertAfter(this),
              e
          ...
          ;(t.path = g),
            ...
            (t.path.toRelative = function (e) {
              ...
              var i = [],
                ...
                l = 0
              'M' == e[0][0] &&
                ((s = a = e[0][1]), (u = o = e[0][2]), l++, i.push(['M', a, o]))
