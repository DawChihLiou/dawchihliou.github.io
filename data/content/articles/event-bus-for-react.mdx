...
description: 'Building a Type Safe Event Bus from scratch with TypeScript and discovering use cases in React.'
...
I created an [Remix](https://remix.run) application to demonstrate how to use the Event Bus we just built.
...
There's also an interesting [discussion on Reddit about using Redux as an Event Bus](https://www.reddit.com/r/javascript/comments/qrpvsq/askjs_thoughts_on_using_redux_actions_as_an_event/). One of the maintainer suggested a few Redux based tools to handle events:
