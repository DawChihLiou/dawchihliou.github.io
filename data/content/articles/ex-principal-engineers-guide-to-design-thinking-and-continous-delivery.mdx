...
Design thinking and continuous delivery are amazing approaches to product innovation. They are not widely known when we talk about agile methodologies, but the synergy between them is crucial to build products that people love.
...
⏭ Ready for the next article? 👉 [**Building A Custom Google Maps Marker React Component Like Airbnb in Next.js**](/building-custom-google-maps-marker-react-component-like-airbnb-in-nextjs)
