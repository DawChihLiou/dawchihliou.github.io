...
We'll be building a proof of concept to create customer markers using any React components.
...
I integrated the Google Maps API in a [Next.js](https://vercel.com/solutions/nextjs) project by following the [official tutorial](https://developers.google.com/maps/documentation/javascript/react-map). The tutorial explains in detail how to render Google Maps and markers in your React applications.

There are a couple more integrations included in the project:
...
- a soft animation to transition the marker's apparence,
...
It looks like a lot of code to create a custom marker but the concept is actually very straightforward:
...
- When the React marker component is ready to render, we portal the component to the container in the map.
