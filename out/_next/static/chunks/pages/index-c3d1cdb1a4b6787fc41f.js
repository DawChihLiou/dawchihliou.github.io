  ...
  [13],
  {
                  ...
                  q(
                    ...
                    e.external &&
                      q(
                        ...
                        'Published on ',
                        q('span', null, e.publisher)
                      ),
                    q('p', null, e.description)
                  )
                )
              )
            })
    ...
    Nx7O: function (e, t, n) {
      ...
      e.exports = function (e, t, n) {
        ...
        if (W >= 4) return
        if (((p = t.charAt(q)), (o = D ? b : y), !0 === v[p])) (h = p), (l = !1)
        else {
          for (l = !0, a = ''; q < M && ((p = t.charAt(q)), i(p)); )
            (a += p), q++
          if (((p = t.charAt(q)), !a || !0 !== o[p])) return
          ;(J = parseInt(a, 10)), (h = p)
        }
        if ((p = t.charAt(++q)) !== c && p !== f) return
        if (n) return !0
        ;(q = 0), (T = []), (j = []), (O = [])
        for (; q < M; ) {
          for (
          ...
          if (
            ...
            if (!0 === v[p]) (k = p), q++, W++
              ...
              for (a = ''; q < M && ((p = t.charAt(q)), i(p)); ) (a += p), q++
              ;(p = t.charAt(q)),
                q++,
                a && !0 === o[p] && ((k = p), (W += a.length + 1))
            }
            if (k)
              if ((p = t.charAt(q)) === f) (W += 4 - (W % 4)), q++
              else if (p === c) {
                for (z = q + 4; q < z && t.charAt(q) === c; ) q++, W++
                q === z && t.charAt(q) === c && ((q -= 3), (W -= 3))
              } else p !== u && '' !== p && (k = null)
          }
          if (k) {
            if (!R && h !== k) break
    ...
    Y6TP: function (e, t, n) {
      ...
      e.exports = function (e, t) {
        ...
        return (function (e, t) {
          ...
          function ee(e, t) {
            var n = K()
            ;(n.column += t), (n.offset += t), F.call(M, y[e], n, e)
          }
          function te() {
            Y &&
              (Q.push(Y), D && D.call(U, Y, { start: N, end: K() }), (Y = ''))
          }
        })(e, a)
      }
