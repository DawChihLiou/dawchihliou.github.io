              ...
              return O(
                ...
                O(
                  ...
                  O(
                    ...
                    O('span', { className: C.a.description }, t.title)
                  ),
                  O(
                    'div',
        ...
        return S(
          ...
          S(
            ...
            T.map(function (t) {
              return S(
                'div',
                { key: t.title, className: P.a.item },
                S(
                  'div',
                  { className: P.a.itemImage },
                  S('img', { src: t.image, alt: t.description })
                ),
                S(
                  'div',
      ...
      function s(t, e, n) {
        ...
        if (
          ...
          for (
            ...
            if (((h = T = e.charAt(j)), '`' === T)) {
              for (s = 1; '`' === e.charAt(j + 1); ) (h += T), j++, s++
              c ? s >= c && (c = 0) : (c = s)
            } else if ('\\' === T) j++, (h += e.charAt(j))
            else if ((c && !S) || '[' !== T) {
              if ((!c || S) && ']' === T) {
                if (!k) {
                  if (!E)
                    for (; j < y && ((T = e.charAt(j + 1)), r(T)); )
                      (h += T), j++
          ...
          if (o) {
            for (g = w, O += w + h, j++; j < y && ((T = e.charAt(j)), r(T)); )
              (O += T), j++
            if (
              ((T = e.charAt(j)), (d = P ? l : a), (w = ''), (u = O), '<' === T)
            ) {
              for (j++, u += '<'; j < y && '>' !== (T = e.charAt(j)); ) {
                if (P && '\n' === T) return
                ;(w += T), j++
              }
            ...
            for (w = ''; j < y && ((T = e.charAt(j)), r(T)); ) (w += T), j++
            if (((T = e.charAt(j)), (O += w), w && i.call(d, T)))
              if ((j++, (O += T), (w = ''), (v = d[T]), (f = O), P)) {
                for (; j < y && (T = e.charAt(j)) !== v; )
                  '\\' === T && ((w += '\\'), (T = e.charAt(++j))),
                    j++,
                    (w += T)
                if ((T = e.charAt(j)) !== v) return
                for (
                  b = w, O += w + T, j++;
                  j < y && ((T = e.charAt(j)), r(T));
      ...
      t.exports = function (t, e, n) {
        ...
        for (; z < q; ) {
          ...
          if (
            ...
            if (y)
              if ('\t' === (c = e.charAt(z))) (D += 4 - (D % 4)), z++
                ...
                for (I = z + 4; z < I && ' ' === e.charAt(z); ) z++, D++
                z === I && ' ' === e.charAt(z) && ((z -= 3), (D -= 3))
              } else '\n' !== c && '' !== c && (y = null)
          }
          if (y) {
            if (!L && u !== y) break
          ...
          if (
            ...
            break
          if (((w = A), (A = !r(b).length), N && O))
            (O.value = O.value.concat(C, k)), (_ = _.concat(C, k)), (C = [])
          else if (p)
            0 !== C.length && (O.value.push(''), (O.trail = C.concat())),
        ...
        for (; ++z < q; )
          (O = x[z].value.join('\n')),
            (S = t.now()),
            (O = t(O)(v(this, O, S), P)).loose && (E = !0),
            (O = x[z].trail.join('\n')),
            z !== q - 1 && (O += '\n'),
            t(O)
        return j(), T(), (P.loose = E), P
      }
      var c = /\n\n(?!\s*$)/,
        u = /^\[([ \t]|x|X)][ \t]/,
        f = /^([ \t]*)([*+-]|\d+[.)])( {1,4}(?! )| |\t|$|(?=\n))([^\n]*)/,
    ...
    ZWk2: function (t, e, n) {
      ...
      t.exports = function (t, e) {
        ...
        return (function (t, e) {
          ...
          ;(I = K()), (_ = F ? tt : f), Z--, W++
          for (; ++Z < W; )
            if ((10 === w && (V = $[Y] || 1), 38 === (w = t.charCodeAt(Z)))) {
              if (
              ...
              for (
                T = E = Z + 1,
                  ...
                  S = v[P],
                  L--;
                ++L < W && S((x = t.charCodeAt(L)));

              )
                (h += u(x)), P === p && c.call(r, h) && ((n = h), (j = r[h]))
              ;(a = 59 === t.charCodeAt(L)) &&
                (L++, (i = P === p && s(h)) && ((n = h), (j = i))),
                (H = 1 + L - E),
                (a || B) &&
                ...
                A
                  ? (et(),
                    ...
                    Q.push(A),
                    (N = K()).offset++,
                    q && q.call(M, A, { start: I, end: N }, t.slice(E - 1, L)),
                    (I = N))
                  : ((h = t.slice(E - 1, L)),
                    (G += h),
                    (V += h.length),
          ...
          function tt(t, e) {
            var n = K()
            ;(n.column += e), (n.offset += e), F.call(U, y[t], n, t)
          }
          function et() {
            G &&
              (Q.push(G), z && z.call(D, G, { start: I, end: K() }), (G = ''))
          }
        })(t, a)
      }
