      ...
      var x = [
          {
            title: 'react-use-pip',
            description:
              'react-use-pip is React hook library for Picture in Picture. It seamlessly detects browser support and provides flexible APIs for developers to have full control over Picture in Picture feature.',
            image: '/raw/logo-react-use-pip.svg',
            darkmodeImage: '/raw/logo-react-use-pip.svg',
          ...
          },
          {
            ...
            image: '/optimized/raw/logo-npm.webp',
            darkmodeImage: '/optimized/raw/logo-npm.webp',
            link:
          ...
          },
          {
            ...
            image: '/optimized/raw/logo-github.webp',
            darkmodeImage: '/optimized/raw/logo-github.webp',
          ...
          },
          {
            ...
            image: '/optimized/raw/logo-spes.webp',
            darkmodeImage: '/optimized/raw/logo-spes.webp',
            link: 'https://spes.me/',
          },
        ],
        y = c(493),
          ...
          children: [
            (0, e.jsxs)('article', {
              ...
              children: [
                ...
                (0, e.jsx)('p', {
                  children:
                    "I've been working on open source and non-profit projects! It brings me so much joy contributing back to the community.",
                }),
                (0, e.jsx)('p', {
                  children:
                ...
                (0, e.jsxs)('p', {
                  children: [
                    ...
                    " years working on Web engineering in startups, public tech companies, and Fortune 500 enterprises. I've built features, architectures, and infrastructure for client facing products and enterprise software.",
                  ],
                }),
              ],
            }),
