      ...
      function N() {
        return E(
          ...
          E(
            ...
            E('h1', null, 'Some of my Open Source projects'),
            E(
              'p',
              null,
              ...
              return E(
                ...
                E(
                  ...
                  E(
                    ...
                    E('img', { src: e.image, alt: e.title, loading: 'lazy' })
                  )
                ),
                E(
                  'div',
    ...
    Nx7O: function (e, t, n) {
      ...
      e.exports = function (e, t, n) {
        ...
        for (; ++z < F; )
          (T = x[z].value.join('\n')),
            (E = e.now()),
            (T = e(T)(v(this, T, E), P)).loose && (I = !0),
            (T = x[z].trail.join('\n')),
            z !== F - 1 && (T += '\n'),
            e(T)
        return O(), j(), (P.loose = I), P
      }
      var c = /\n\n(?!\s*$)/,
        u = /^\[([ \t]|x|X)][ \t]/,
        f = /^([ \t]*)([*+-]|\d+[.)])( {1,4}(?! )| |\t|$|(?=\n))([^\n]*)/,
            ...
            if ((10 === w && (V = $[Y] || 1), 38 === (w = e.charCodeAt(W)))) {
              ...
              for (
                j = I = W + 1,
                  ...
                  E = v[P],
                  L--;
                ++L < Z && E((x = e.charCodeAt(L)));

              )
                (h += u(x)), P === p && c.call(r, h) && ((n = h), (O = r[h]))
              ;(a = 59 === e.charCodeAt(L)) &&
                (L++, (i = P === p && s(h)) && ((n = h), (O = i))),
                (H = 1 + L - I),
                (a || R) &&
