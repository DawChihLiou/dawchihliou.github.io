_N_E = (window.webpackJsonp_N_E = window.webpackJsonp_N_E || []).push([
  [8],
  {
    ...
    cha2: function (t, e, r) {
      ...
      var n = r('q1tI'),
        a = r.n(n),
        s = (r('9d8Q'), r('jBpo'), r('zPlV'), r('asrx'), r('RBUq'), r('8Kt/')),
        o = r.n(s),
        l = r('YFqc'),
        i = r.n(l),
        u = r('6HWB'),
        ...
        return T(
          ...
          T(
            y.push,
            {
              ...
              customBurgerIcon: T(v.c, null),
              customCrossIcon: T(v.f, null),
              disableAutoFocus: !0,
            },
            T('a', { href: '/' }, 'Home'),
            T('a', { href: '/now' }, 'Now'),
            T('a', { href: '/articles' }, 'Articles')
          )
        )
      }
      ...
      e.default = function (t) {
        ...
        return w(
          ...
          w(
            ...
            w('meta', {
              name: 'description',
              content: "Daw-Chih Liou's portfolio. ".concat(d.a.description),
            })
          ),
          w(
            'div',
            { id: 'outer-container' },
            w(C, null),
            w('div', { id: 'page-wrap' }, w(e, r), w(b, null))
          )
        )
      }
    },
        ...
        var a,
          ...
          v = function (t, e) {
            var r,
              ...
              m = [],
              h = a
            ;(m.firstDefined = d), (m.lastDefined = p), (a = t), (s = 0)
