          ...
          y(
            ...
            y(
              ...
              y(
                'p',
                null,
                y('a', { href: h, target: '_blank', rel: 'noreferrer' }, 'MDX')
              )
            ),
            y(
              'div',
        ...
        return w(
          ...
          w(
            b.push,
            {
              ...
              customBurgerIcon: w(v.c, null),
              customCrossIcon: w(v.f, null),
              disableAutoFocus: !0,
            },
            w('a', { href: '/' }, 'Home'),
            w('a', { href: '/now' }, 'Now'),
            ...
            if (e) {
              ...
              if (r.length > 1)
                ...
                for (n = 0, a = r.length; n < a; n++)
                  for (p = 0; p < y.length; p += c.length - 2) {
                    if (((c = [p, 1]), (o = y[p].n), '*' != r[n]))
                      o[r[n]] &&
                        (c.push(o[r[n]]), g.unshift({ n: o, name: r[n] }))
                    else
                      for (u in o)
                        o[s](u) && (c.push(o[u]), g.unshift({ n: o, name: u }))
                    y.splice.apply(y, c)
                  }
