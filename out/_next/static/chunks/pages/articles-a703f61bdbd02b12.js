      ...
      function k() {
        return (0, d.jsxs)('div', {
          ...
          children: [
            (0, d.jsxs)(e.default, {
              children: [
                (0, d.jsx)('title', { children: 'Articles' }),
            ...
            (0, d.jsxs)('main', {
              ...
              children: [
                ...
                (0, d.jsx)('div', {
                  className: h().articles,
                  children: f.Z.map(function (a) {
                    return (0,
                    d.jsxs)('section', { className: h().grid, children: [(0, d.jsx)('div', { className: h().date, children: (0, d.jsx)('p', { children: a.date }) }), (0, d.jsxs)('article', { className: h().description, children: [(0, d.jsx)('p', { className: h().category, children: a.category }), a.external && (0, d.jsx)('a', { href: a.url, target: '_blank', rel: 'noreferrer', children: a.title }), !a.external && (0, d.jsx)(i.default, { href: a.url, children: a.title }), a.external && (0, d.jsxs)('a', { href: a.publisherUrl, target: '_blank', rel: 'noreferrer', className: h().caption, children: ['Published on ', (0, d.jsx)('span', { children: a.publisher })] }), (0, d.jsx)('p', { children: a.description }), (0, d.jsxs)('div', { children: [(0, d.jsx)('img', { src: a.avatar, alt: a.author, className: h().avatar, loading: 'lazy' }), (0, d.jsx)('a', { href: a.social, className: h().author, children: (0, d.jsx)('span', { children: a.author }) })] })] })] }, a.url)
                  }),
                }),
              ],
            }),
